...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .order-summary { background: #f1f1f1; padding: 25px; border-radius: 8px; margin: 25px 0; }
    .order-item { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #ddd; }
    .order-item:last-child { border-bottom: none; }
    .totals { border-top: 2px solid #d87d4a; padding-top: 20px; margin-top: 20px; }
    .total-row { display: flex; justify-content: space-between; margin: 8px 0; }
    .grand-total { font-size: 18px; font-weight: bold; color: #d87d4a; margin-top: 15px; }
    ...
    .audiophile-logo { font-size: 28px; font-weight: bold; letter-spacing: 3px; margin-bottom: 10px; }
    .thank-you { font-size: 24px; font-weight: bold; margin: 20px 0; color: #000; }
    .order-number { background: #d87d4a; color: white; padding: 8px 16px; border-radius: 4px; display: inline-block; margin: 10px 0; }
    @media (max-width: 600px) { .content { padding: 20px; } .order-summary { padding: 15px; } }
  </style>
</head>
<body>
  <div class="container">
