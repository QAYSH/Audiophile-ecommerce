  ...
  return (
    <>
      <header className="bg-black text-white">
        <div className="max-w-[1110px] h-[30px] ml-[165px] mx-auto flex items-center justify-between py-8">
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute left-0 right-0 top-20 bg-white text-black shadow-lg z-50">
            <div className="max-w-[1110px] ml-[165px] mx-auto px-6 py-8 space-y-8">
