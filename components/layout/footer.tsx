// components/layout/footer.tsx - Updated to match exact Figma design
import Link from 'next/link'

export function Footer() {
  return (
    <footer className="bg-black text-white">
      <div className="max-w-[1110px] mx-auto px-6 py-12 md:py-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 md:gap-0 mb-8">
          ...
          <nav className="flex flex-col md:flex-row gap-4 text-center md:text-left">
            <Link href="/" className="text-sm font-bold uppercase tracking-wider hover:text-orange-500 transition-colors">
              Home
            </Link>
            <Link href="/category/headphones" className="text-sm font-bold uppercase tracking-wider hover:text-orange-500 transition-colors">
              Headphones
            </Link>
            <Link href="/category/speakers" className="text-sm font-bold uppercase tracking-wider hover:text-orange-500 transition-colors">
              Speakers
            </Link>
            <Link href="/category/earphones" className="text-sm font-bold uppercase tracking-wider hover:text-orange-500 transition-colors">
              Earphones
            </Link>
          </nav>
        </div>
        
        {/* Middle Section - Social Icons aligned with navigation links */}
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-6 mb-6">
          ...
          {/* Social Media Icons - Centered and moved up */}
